...
% TODO: add the other functions, use piecewise for conversions because it gets reset
% TODO: account for truncating integer semantics
% TODO: use begin equation, diagrams for rounding would be nice, etc
